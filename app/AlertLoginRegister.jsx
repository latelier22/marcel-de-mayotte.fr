...
const AlertLoginRegister = () => {
    ...
    return (
        <div
          className={`container mx-auto my-8 p-4 flex justify-center items-center  flex-row gap-8 rounded-md dark:bg-black border-gold-500 border-solid border-2 animate-fadeInOut`}
        >
          <h1
          className="text-xl">
             Pensez à vous connecter ou vous inscrire pour pouvoir commenter les articles du blog, et mémoriser vos tableaux favoris 
            </h1>
            <a
