  ...
  return (
    ...
    <>
      ...
      <div className="flex items-center py-4">
        ...
        {/* <!-- Your text here --> */}
        <span className="flex-shrink px-4  text-transparent text-3xl bg-clip-text bg-gradient-to-br from-gold-800 via-gold-400 to-gold-800 italic font-light">{title}</span>
