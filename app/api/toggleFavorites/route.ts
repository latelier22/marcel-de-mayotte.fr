...
export async function POST(request) {
  const { userId, photoId, toggleFavorites } = await request.json();
  console.log(userId, photoId, toggleFavorites)

  try {
      // Toggle favorite logic
      console.log(userId, photoId, "toggleFavorite",toggleFavorites)
      if (toggleFavorites) {
