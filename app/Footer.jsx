  ...
  return (
    <footer className="bg-neutral-200 text-center text-black dark:bg-neutral-900 dark:text-gold-400">
      <div className="flex items-center justify-center border-neutral-200 p-6 dark:border-neutral-500 lg:justify-end">
        <div className="mr-12 hidden md:block"></div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mb-4">
          <div className="mb-6">
            ...
            <div className="flex justify-center items-center">
              <a
                href={site.facebook}
                className="flex flex-row mr-6 text-sky-700  dark:text-sky-300"
              >
                <svg
          ...
          <div className="mb-6 flex-col flex items-center">
            <h5 className="mb-2.5 font-bold text-black dark:text-neutral-200"></h5>

            {/* Parent relatif + hauteur => Image en fill */}
            <div className="relative h-60 w-60">
              <Image
                src="/images/logo-banniere.png"
                alt="Logo bannière"
                fill
                sizes="240px"
      ...
      <div className="bg-neutral-200 p-6 text-center dark:bg-neutral-700 flex justify-center items-center">
        ...
        <a className="mx-3" href="#">
          {/* Image externe => width/height (simple) */}
          <Image
